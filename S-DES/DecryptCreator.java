...
public class DecryptCreator {
    ...
    // temp[i] = '1';
    // }
    // String cOut = new String(temp, 0, temp.length);
    // return cOut;
    // }
    ...
    public void init() {
        ...
        this.sbox1 = new String[][] { { "01", "00", "11", "10" }, { "11", "10", "01",
                "00" },
                { "00", "10", "01", "11" },
                { "11", "01", "00", "10" } };
        this.sbox2 = new String[][] { { "00", "01", "10", "11" }, { "10", "11", "01",
                "00" },
                { "11", "00", "01", "00" },
                { "10", "01", "00", "11" } };
